  ...
  <head>
    ...
    <section id="box-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputText" name="nama_produk">
        </div>
        <div class="form-group">
            <label for="exampleInputText1">Keterangan</label>
            <input type="text" class="form-control" id="exampleInputText1" name = "keterangan">
        </div>
        <div class="form-group">
            <label for="exampleInputNumber">Harga</label>
            <input type="number" class="form-control" id="exampleInputNumber" name = "harga">
        </div>
        <div class="form-group">
            <label for="exampleInputNumber1">Jumlah</label>
            <input type="number" class="form-control" id="exampleInputNumber1" name = "jumlah">
        </div>
